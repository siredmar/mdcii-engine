...
public:
    ...
    int textureSwitchFlags() const
    {
        return mFlags;
    }
    void setTextureSwitchFlags(int buttonFlags)
    {
        mFlags = buttonFlags;
    }

    /// Get the primary SDL_Texture
    SDL_Texture* primaryTexture() const
    {
        return mPrimaryTexture;
    }
    /// Set the primary SDL_Texture
    void setPrimaryTexture(SDL_Texture* texture)
    {
        mPrimaryTexture = texture;
    }

    /// Get the secondary SDL_Texture
    SDL_Texture* secondaryTexture() const
    {
        return mSecondaryTexture;
    }
    /// Set the secondary SDL_Texture
    void setSecondaryTexture(SDL_Texture* texture)
    {
        mSecondaryTexture = texture;
    }
