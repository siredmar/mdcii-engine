...
Theme::Theme(SDL_Renderer* ctx)
{
    ...
    /* TextBox */
    mTextBoxGradientTopFocused = Color(150, 32);
    mTextBoxGradientBotFocused = Color(32, 32);
    mTextBoxGradientTopUnfocused = Color(255, 0, 0, 100);
    mTextBoxGradientBotUnfocused = Color(255, 0, 0, 50);
    mTextBoxGradientTopBackground = Color(255, 128);
